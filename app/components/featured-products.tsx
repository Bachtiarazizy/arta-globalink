...
export default function FeaturedProducts() {
  ...
  return (
    <section ref={sectionRef} id="products" className="bg-gradient-to-b from-white to-gray-50 py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 overflow-x-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute -left-24 bottom-20 w-48 h-48 rounded-full bg-[#25D366] bg-opacity-5 z-0 hidden lg:block"></div>
        <div className="absolute -right-10 top-1/3 w-24 h-24 rounded-full border-4 border-[#25D366] border-opacity-10 z-0 hidden lg:block"></div>
      </div>
    </section>
  );
}
